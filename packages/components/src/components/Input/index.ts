...
import BaseInput from "./__helpers__/InputBase";
...
export type { InputState, InputType, Props as BaseInputProps, ReactInputHTMLAttributes } from "./__helpers__/InputBase";
